...
public class CreateSaleCommandValidatorTests
{
    ...
    {
        // Given
        var command = CreateSaleHandlerTestData.GenerateValidCommand() with { CustomerId = Guid.Empty };
    ...
    {
        // Given
        var command = CreateSaleHandlerTestData.GenerateValidCommand() with { CustomerName = string.Empty };
    ...
    [Fact(DisplayName = "Given CustomerName exceeding 100 chars When validating Then fails validation")]
    public void Validate_CustomerNameTooLong_FailsValidation()
    {
        // Given
        var command = CreateSaleHandlerTestData.GenerateValidCommand() with { CustomerName = new string('A', 101) };
    ...
    {
        // Given
        var command = CreateSaleHandlerTestData.GenerateValidCommand() with { BranchId = Guid.Empty };
    ...
    {
        // Given
        var command = CreateSaleHandlerTestData.GenerateValidCommand() with { Items = [] };
    ...
    public void Validate_ItemUnitPriceZero_FailsValidation()
    {
        // Given
        var command = CreateSaleHandlerTestData.GenerateValidCommand() with
        {
    ...
    public void Validate_ItemEmptyProductName_FailsValidation()
    {
        // Given
        var command = CreateSaleHandlerTestData.GenerateValidCommand() with
        {
