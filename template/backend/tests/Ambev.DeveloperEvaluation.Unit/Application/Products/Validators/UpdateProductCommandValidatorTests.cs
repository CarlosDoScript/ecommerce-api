...
public class UpdateProductCommandValidatorTests
{
    ...
    [Fact(DisplayName = "Valid update command should pass all validation rules")]
    ...
    public void Given_InvalidTitle_When_Validated_Then_ShouldHaveError(string title)
    {
        ...
        var command = new UpdateProductCommand
        {
            Id = Guid.NewGuid(), Title = title, Price = 10m, Description = "desc",
            Category = "cat", Rating = new UpdateProductRatingCommand()
        };
    ...
    public void Given_TitleExceedingMaxLength_When_Validated_Then_ShouldHaveError()
    {
        ...
        var command = new UpdateProductCommand
        {
            Id = Guid.NewGuid(), Title = ProductTestData.GenerateLongTitle(),
            Price = 10m, Description = "desc", Category = "cat",
            Rating = new UpdateProductRatingCommand()
        };
    ...
    public void Given_InvalidPrice_When_Validated_Then_ShouldHaveError(double price)
    {
        ...
        var command = new UpdateProductCommand
        {
            Id = Guid.NewGuid(), Title = "Valid Title", Price = (decimal)price,
            Description = "desc", Category = "cat", Rating = new UpdateProductRatingCommand()
        };
    ...
    public void Given_InvalidCategory_When_Validated_Then_ShouldHaveError(string category)
    {
        ...
        var command = new UpdateProductCommand
        {
            Id = Guid.NewGuid(), Title = "Valid Title", Price = 10m,
            Description = "desc", Category = category, Rating = new UpdateProductRatingCommand()
        };
    ...
    public void Given_CategoryExceedingMaxLength_When_Validated_Then_ShouldHaveError()
    {
        ...
        var command = new UpdateProductCommand
        {
            Id = Guid.NewGuid(), Title = "Valid Title", Price = 10m, Description = "desc",
            Category = ProductTestData.GenerateLongCategory(), Rating = new UpdateProductRatingCommand()
        };
    ...
    public void Given_EmptyDescription_When_Validated_Then_ShouldHaveError(string description)
    {
        ...
        {
            Id = Guid.NewGuid(), Title = "Valid Title", Price = 10m,
            Description = description, Category = "cat", Rating = new UpdateProductRatingCommand()
        };
    ...
    public void Given_RatingRateAboveMax_When_Validated_Then_ShouldHaveError()
    {
        ...
        var command = new UpdateProductCommand
        {
            Id = Guid.NewGuid(), Title = "Valid Title", Price = 10m, Description = "desc",
            Category = "cat",
            Rating = new UpdateProductRatingCommand { Rate = ProductTestData.GenerateInvalidRate(), Count = 10 }
        };
    ...
    public void Given_NegativeRatingCount_When_Validated_Then_ShouldHaveError()
    {
        ...
        var command = new UpdateProductCommand
        {
            Id = Guid.NewGuid(), Title = "Valid Title", Price = 10m, Description = "desc",
            Category = "cat",
            Rating = new UpdateProductRatingCommand { Rate = 4m, Count = ProductTestData.GenerateInvalidCount() }
        };
